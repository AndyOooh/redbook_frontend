...
export const Intro = ({ user, visitor }) => {
  ...
  const detailsArray = [
    {
      ...
      text:
        details?.job && details?.workPlace
          ...
          : details?.workPlace.value && !details?.job && `Works at ${details?.workPlace.value}`,
  ...
  return (
    <>
      ...
      <p>Hiiii</p>
      <p>{details?.workPlace.visibility}</p>
      <p>{details?.workPlace.visibility}</p>
      <p>{details?.otherName.visibility}</p>
      <p>{details?.otherName.visibility}</p>
